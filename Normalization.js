...
var diss2021 = ee.Image('projects/ee-belly200023/assets/featurehk/diss2021hk')
...
var diss = diss2023.addBands(diss2022).addBands(diss2021).addBands(diss2020).addBands(diss2019).addBands(diss2018).addBands(diss2017).addBands(diss2016).addBands(diss2015).addBands(diss2014).addBands(diss2013)
...
var savg = savg2023.addBands(savg2022).addBands(savg2021).addBands(savg2020).addBands(savg2019).addBands(savg2018).addBands(savg2017).addBands(savg2016).addBands(savg2015).addBands(savg2014).addBands(savg2013)
